            ...
            <div class="accordion-body">
              ...
              <div class="container mt-3" id="container-petunjuk">
                <div class="mt-4">
                  ...
                  <p class="text-muted">Transfer instructions are here</p>
                </div>
      ...
      <div class="card position-sticky top-0">
        <div class="p-3 bg-light bg-opacity-10">
          ...
          <div id="transaction">
            ...
            <div class="d-flex justify-content-between mb-1 small">
              <span>Delivery</span><span>
                <span>$ </span><span id="shipping" data-shippingCost="0">0</span>
              </span>
            </div>
          ...
          <div class="d-flex justify-content-between mb-4 small">
            <span>TOTAL</span> <strong class="text-dark"><span>$ </span><span id="total">0</span></strong>
            <input type="hidden" name="total_price" id="total_price" value="{{ old('total_price', '0') }}">
          </div>
          <div class="form-group small mb-3">
            Make sure you really understand the order you make.
          </div>
