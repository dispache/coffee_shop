                          ...
                          <div class="col-12 col-md-3">
                            <div class="form-group">
                              ...
                              <input type="hidden" id="product_price" name="product_price"
                                data-truePrice="{{ old('price', $order->product->price) }}" value="$
                            {{ old('price', $order->product->price) }}" type="text" class="form-control" disabled>
                              ...
                              <input type="hidden" id="product_price" name="product_price"
                                ...
                                value="$ {{ old('product_price', ((100 - $order->product->discount)/100) *$order->product->price) }}"
                              ...
                              <div class="input-group" style="display:unset;">
                                <div class="input-group-prepend">
                                  ...
                                  @else
                                  <span class="input-group-text">$ {{ ((100 - $order->product->discount)/100) *
        ...
        <div class="p-3 bg-light bg-opacity-10">
          ...
          <div id="transaction">
            <div class="d-flex justify-content-between mb-1 small">
              <span>Subtotal</span> <span><span>$ </span> <span id="sub-total">0</span></span>
            </div>
            <div class="d-flex justify-content-between mb-1 small">
              <span>Shipping Cost</span> <span><span>$ </span><span id="shipping"
          ...
          <div class="d-flex justify-content-between mb-4 small">
            <span>TOTAL</span> <strong class="text-dark"><span>$ </span><span id="total">
                {{ $order->total_price }}
              </span></strong>
